...
class DataValidation:
  ...
  def preprocess_data(self):
    try:
      ...
      final_rating.drop_duplicates(['user_id','title'],inplace=True)  #taking only first appearence, when the same user rated a book for multiple times.
      ...
      pickle.dump(final_rating,open(os.path.join(self.data_validation_config.serialized_obj_dir, "final_rating.pkl"),'wb'))
      logging.info(f"Saved final_rating serialization object to {self.data_validation_config.serialized_obj_dir}")
